...
<main class="main-wrapper clearfix">
    ...
    <div class="row page-title clearfix">
        <div class="page-title-left">
            <h5 class="mr-0 mr-r-5">Edit User</h5>
            ...
            <div class="col-md-12 widget-holder">
                <div class="widget-bg">
                    <div class="widget-body clearfix">
                        ...
                        <input type="hidden" value="{{$result->admin_id}}" name="admin_id">
                        
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label" for="l0">User Name:</label>
                            <div class="col-md-9">
                                <input class="form-control" id="l0" type="text" name="user_name" value="{{$result-> admin_name}}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" id="l0" type="email" name="user_email" value="{{$result-> email_address}}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" id="l0" type="password" name="user_password" placeholder="Insert if want to change password">
                            </div>
                        </div>
